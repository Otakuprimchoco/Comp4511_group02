    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        {isAboutPopupVisible &&
          ...
          >
          <AboutGroupPopup description={eventData.description} closePopupFn={() => {setIsAboutPopupVisible(false)}}/>
          </Modal>
        }
        ...
        <View style={{marginLeft: "28%", marginTop: 10, fontSize: 10}}>
        <MainButton text={" On Live!\nJoin it now"} onPressFn={() => navigation.push("JoinCallPopup")}/>
        </View>
      </View>
    </View>
  );
